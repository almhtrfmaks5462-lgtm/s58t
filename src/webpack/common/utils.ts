...
import type * as t from "@S7Cord/discord-types";
...
waitFor(["dispatch", "subscribe"], m => {
    ...
    S7Cord.Api.PluginManager.subscribeAllPluginsFluxEvents(m);
...
// ─── Re-exports for compatibility with S7Cord/S7Cord plugins ────────────────
