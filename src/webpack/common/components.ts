...
import * as t from "@S7Cord/discord-types";
...
export const Forms = {
    ...
    /** @deprecated use Heading from S7Cord */
    FormTitle: Heading,
    /** @deprecated use Paragraph from S7Cord */
    FormText: Paragraph,
...
/** @deprecated use Paragraph, Span, or BaseText from S7Cord */
export const Text = TextCompat;
/** @deprecated use Button from S7Cord */
export const Button = ButtonCompat;
/** @deprecated Use FormSwitch from S7Cord */
...
/** @deprecated import from @S7Cord/components */
