...
import { useState } from "@S7Cord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start S7Cord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start S7Cord minimized when starting with system"}
