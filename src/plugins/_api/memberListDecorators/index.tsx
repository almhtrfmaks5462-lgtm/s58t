            ...
            replacement: [
                {
                    ...
                    replace: "children:[S7Cord.Api.MemberListDecorators.__getDecorators(arguments[0],'guild'),"
                }
            ]
        },
        {
            ...
            replacement: {
                ...
                replace: "decorators:[S7Cord.Api.MemberListDecorators.__getDecorators(arguments[0],'dm'),$1]"
            }
        },
