...
import { Channel, Message, User } from "@S7Cord/discord-types";
...
export default definePlugin({
    ...
    authors: [Devs.Cyn, Devs.TheSun, Devs.RyanCaoDev, Devs.LordElias, Devs.AutumnVN, S7CordDevs.Hen, S7CordDevs.meowabyte],
    settings,
    patches: [
