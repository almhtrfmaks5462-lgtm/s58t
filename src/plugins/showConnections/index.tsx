...
import { ConnectedAccount, User } from "@S7Cord/discord-types";
                    ...
                    : <button
                        ...
                        onClick={() => {
                            if (connection.type === "xbox") {
                                S7CordNative.native.openExternal(`https://www.xbox.com/en-US/play/user/${encodeURIComponent(connection.name)}`);
                            } else {
