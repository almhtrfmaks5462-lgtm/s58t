...
export default ErrorBoundary.wrap(
    ...
    {
        message:
            "Failed to render the S7Cord Settings tab. If this issue persists, try to right click the Nightcord tray icon, then click 'Repair Nightcord'. And make sure your Nightcord is up to date."
    }
);
