<script>
    ...
    // ترجمة عناوين الإجراءات
    let actionTitle = "";
    if (currentAction === "install") actionTitle = "تثبيت";
    else if (currentAction === "repair") actionTitle = "إصلاح";
    else if (currentAction === "uninstall") actionTitle = "إلغاء التثبيت";
    else actionTitle = currentAction;
</script>
